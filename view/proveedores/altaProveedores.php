...
<br>
<div class="row"><div class="col-md-11 col-md-offset-1 col-xs-11 col-xs-offset-1">
  <form class="frmRegistro" action="../../../../controller/proveedores/altaProveedores.php" method="POST" enctype="multipart/form-data" name="frmaltaClientes" id="frmRegistro">
  ...
  <label for="example-search-input" class="col-xs-2 col-md-1 col-form-label">Nombre</label>
   ...
   <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
    <input class="form-control" type="text" id="nombre" placeholder="Nombre" name="nombreProveedor" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+">
  </div> 
</div>
</div>
</div>
...
<div class="form-group has-feedback">
 <label for="example-search-input" class="col-xs-2 col-md-1 col-form-label">Domicilio</label>
   <div class=" col-xs-10 col-md-11">
    ...
    <input class="form-control" type="text" id="domicilio" placeholder="Calle / Número / Colonia" name="domicilio" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+">
  </div> 
</div>
</div>
</div>
...
<div class="form-group has-feedback">
 <label for="example-search-input" class="col-xs-2 col-md-1 col-form-label">Teléfono</label>
   <div class=" col-xs-10 col-md-11">
    ...
    <input class="form-control" type="tel" id="telefono" placeholder="Teléfono" name="telefono" onKeyPress="return solonumeros(event)">
  </div> 
</div>
</div>
</div>
...
<div class="form-group has-feedback">
  <label for="example-search-input" class="col-xs-2 col-md-1 col-form-label">Correo</label>
   <div class=" col-xs-10 col-md-11">
    ...
    <input class="form-control" type="text" id="correo" placeholder="Correo" name="correo" pattern="\w+@+\w+\.+[a-z]">
  </div> 
</div>
</div>
</div>
