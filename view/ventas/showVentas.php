  ...
  <div class="col-md-4"></div>
   ...
   <br>
     ...
     <div class="form-group">
      <input type="text" class="form-control" placeholder="Buscar por descripcion de presupuesto" name="nombre">
     </div>
...
<div class="row">
  ...
  <thead>
    <tr class="success">
      <th class="nombre" align="center">Cliente</th><th>Descripcion de presupuesto</th><th>Fecha de venta</th><th>Monto Total</th>
          </thead>';
